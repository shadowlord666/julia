...
std::unique_ptr<Module> CloneModule2(const Module *M, ValueToValueMapTy &VMap)
{
    auto ShouldCloneDefinition = [](const GlobalValue*) { return true; };
...
// No DataLayout pass needed anymore.
    ...
    ValueToValueMapTy VMap;
#ifdef LLVM38
    Module *clone = CloneModule2(shadow_module, VMap).release();
#else
